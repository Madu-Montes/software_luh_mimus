...
<head>
    ...
    <title>Salgados - Luh' Mimus</title>
...
<body>
    ...
    <div id="main">
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Cadastre os salgados</h3>
                    </div>
                </div>
            </div>
            <nav class="nav justify-content-center ">
                <a class="nav-link add" data-bs-toggle="modal" data-bs-target="#modalId"> + Adicionar salgados ao site </a>
            </nav>
        </div>
        ...
        <?php 
                include '../includes/cardsSalgados.php'
            ?>
